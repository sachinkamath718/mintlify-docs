...
Looking for connectors that will be available soon on the Condense App? Learn More about that here: [Upcoming Connectors on Condense](https://zeliot.mintlify.site/condense/legacy/connectors-in-condense/upcoming-connectors)