...
<Columns cols={2}>
  <Column>
    <Card title="CLOUD PROVIDER" img="/images/cloud-provider.png">
  ...
  <Column>
    <Card title="ZELIOT CENTRAL TOWER" horizontal img="/images/image.avif">
...
<Columns cols={2}>
  <Column>
    <Card title="CONDENSE APPLICATION" img="/images/condense-app-img-2.avif">
