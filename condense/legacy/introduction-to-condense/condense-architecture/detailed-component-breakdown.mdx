...
F**irst Time User? Free Credits on us!**
...
<Info>
  ...
  [https://www.zeliot.in/try-no](https://www.zeliot.in/try-now)w
</Info>
...
>
> [https://www.zeliot.in/blo](https://www.zeliot.in/blog)g

<Columns cols={2}>
  <Column>
    **Previous**

    [Condense Architecture](/condense/legacy/introduction-to-condense/condense-architecture)
  </Column>
  <Column>
    **Next**

    [Additional Services](/condense/legacy/introduction-to-condense/condense-architecture/additional-services)
  </Column>
</Columns>