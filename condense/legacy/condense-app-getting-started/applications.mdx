...
3. Start building and monitor Build Logs; fix errors and rebuild if needed.
   ...
   Guidance on naming/registries: Read [Building an Application.](https://docs.zeliot.in/condense/condense-app-getting-started/applications#building-an-application)
