...
| Field | Description |
| --- | --- |
| **Broker Status** | Number of brokers online versus the total expected in the <br />cluster. |
| **Online Replicas** | Total number of replicas currently in sync and online across<br /> topics. |
| **Fetch Rate (kps)** | The rate of fetch requests per second (in thousands)<br /> handled by the cluster. |
...
| **Produce Request Rate (kps)** | The rate of produce requests per second (in thousands)<br />received by brokers. |
...
- [Kafka Topics](/condense/condense-app-getting-started/kafka-topics)