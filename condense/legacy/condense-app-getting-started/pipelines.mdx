...
**A warning message will appear, stating:** "**_Are you sure you want to delete the connector Title?_**" "**_If you delete the Connector title, you might break the flow of data in the pipeline and might cause problems in your deployed applications._**"
