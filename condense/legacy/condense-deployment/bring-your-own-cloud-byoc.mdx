...
<Card title="IMPORTANT!" type="info">
  ...
  \
  How to Deploy Condense from [Google Cloud Marketplace](https://docs.zeliot.in/condense/condense-deployment/bring-your-own-cloud-byoc/deployment-from-gcp-marketplace)

  How to Deploy Condense from [Microsoft Azure Marketplace](https://docs.zeliot.in/condense/condense-deployment/bring-your-own-cloud-byoc/deployment-from-azure-marketplace)

  How to Deploy Condense from [Amazon Web Services Marketplace](https://docs.zeliot.in/condense/condense-deployment/bring-your-own-cloud-byoc/deployment-from-aws-marketplace)
</Card>