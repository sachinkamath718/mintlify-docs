...
Zeliot shall provide the Customer with a detailed timeline documenting the resolution of each support ticket. The Customer shall have the right to contest any such timeline by submitting a written objection via electronic mail to support\@zeliot.in within seven (7) Business Days of receipt of the timeline documentation.
