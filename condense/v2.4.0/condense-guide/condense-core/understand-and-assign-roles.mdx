...
3. Environment(s) can now be linked to the organization <img src="/images/Understandassign3.png" alt="Understandassign3" />
...
5. Select the member and assign one of the Organization-level roles:
   ...
   -  <img src="/images/Understandassign6.png" alt="Understandassign6" />
