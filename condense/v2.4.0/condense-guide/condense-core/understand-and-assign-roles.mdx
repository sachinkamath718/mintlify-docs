...
![Understandassign1](/images/Understandassign1.png)
...
→ Sees only the workspaces for which a workspace role was assigned → Workspace role must be the same across all selected workspaces
...
<Frame>
  ![Understandassign2 1](/images/Understandassign2-1.png)
</Frame>

1. The creator automatically becomes the **Organization Admin** 

<Frame>
  ![Understandassign3 1](/images/Understandassign3-1.png)
</Frame>

1. Environment(s) can now be linked to the organization <img src="/images/Understandassign3.png" alt="Understandassign3" />
...
3. Enter user details <img src="/images/Understandassign4.png" alt="Understandassign4" />
4. Send invite

Once accepted, the member appears under the organization.

![Understandassign5](/images/Understandassign5.png)
...
5. Select the member and assign one of the Organization-level roles:
   ...
   - Environment User (for selected environments) <img src="/images/Understandassign6.png" alt="Understandassign6" />

<Danger>
  You cannot assign any role to a member if there is no Environment associated with the organization.
</Danger>
...
This determines the member's access level inside Condense Core.
...
| Access only assigned Workspaces | N/A | ✅ |
