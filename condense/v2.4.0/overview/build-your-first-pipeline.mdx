...
![](/images/gitbook/image.png) Use **clear topic naming** to make the pipeline canvas self-explanatory

![](/images/gitbook/image.png) **Group related connectors and transforms** logically to simplify understanding

![](/images/gitbook/image.png) **Avoid unused topic links** to reduce visual clutter

![](/images/gitbook/image.png) **Regularly check component logs** to catch issues early

![](/images/gitbook/image.png) Document the pipeline purpose in the workspace description
