...
[PreviousKafka Connect](/condense/v2.4.0/overview/fully-managed-kafka/kafka-connect)[NextSecuring Kafka](/condense/v2.4.0/overview/fully-managed-kafka/securing-kafka)
