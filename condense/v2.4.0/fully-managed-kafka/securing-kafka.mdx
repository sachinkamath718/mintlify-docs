...
[PreviousSchema Registry](/condense/v2.4.0/fully-managed-kafka/schema-registry)[NextKafka Administration](/condense/v2.4.0/fully-managed-kafka/kafka-administration)
