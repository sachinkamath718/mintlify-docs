...
Learn more on how SSO is implemented in Condense, including sign-up and sign-in workflows by reading the detailed guide here: [SSO (Single Sign On)](/condense/v2.4.0/condense-app-getting-started/sso-single-sign-on-creating-an-account-logging-into-the-condense-app)
...
Learn more on how RBAC is implemented in Condense, by reading the detailed guide here: [RBAC (Role Based Access Control)](/condense/v2.4.0/condense-guide/condense-console/roles-and-permissions)
...
Learn more on how Workspaces and Pipelines are implemented in Condense, by reading the detailed guide here: [Workspace in Conden](/condense/v2.4.0/condense-guide/condense-core/create-your-workspace)
...
Learn more about how Applications and Transforms are implemented in Condense, by reading the detailed guide here: [Build your own Transforms in Condense](/condense/v2.4.0/deep-dive/applications)
...
Learn more on how to find and use various connectors that are available in Condense, by reading the detailed guide here: [Connectors in Condense](/condense/v2.4.0/condense-guide/condense-core/deploy-an-input-connector)
...
Learn more on how to access and modify settings in the Condense App, by reading the detailed guide here: [Available Settings in Condense](/condense/v2.4.0/other-features/settings)
...
[PreviousFeatures of Condense App](/condense/v2.4.0/condense-app-getting-started/features-of-condense-app)[NextCondense Guide](/condense/v2.4.0/condense-guide)
