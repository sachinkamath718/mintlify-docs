...
Condense supports two categories of Kafka Connect connectors.
...
<Info>
  In the context of Kafka Connect, a _partition_ can mean a topic partition or a _shard of data_ in an external system.
</Info>
